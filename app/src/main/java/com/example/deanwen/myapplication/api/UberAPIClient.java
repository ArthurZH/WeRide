package com.example.deanwen.myapplication.api;

import com.example.deanwen.myapplication.BuildConfig;
import com.example.deanwen.myapplication.Constants;
import com.example.deanwen.myapplication.model.PriceEstimateList;
import com.example.deanwen.myapplication.model.ProductList;
import com.example.deanwen.myapplication.model.Profile;
import com.example.deanwen.myapplication.model.TimeEstimateList;
import com.example.deanwen.myapplication.model.UserActivity;
...
public class UberAPIClient {
    ...
    public interface UberAPIInterface {
        ...
        void getProducts(@Header("Authorization") String authToken,
                         ...
                         UberCallback<ProductList> callback);
        ...
        void getTimeEstimates(@Header("Authorization") String authToken,
                              ...
                              UberCallback<TimeEstimateList> callback);
        ...
        void getPriceEstimates(@Header("Authorization") String authToken,
                               ...
                               UberCallback<PriceEstimateList> callback);
        ...
        void getUserActivity(@Header("Authorization") String authToken,
                             ...
                             UberCallback<UserActivity> callback);
